...
func main() {
	...
	for _, p := range pokemons {
		...
		case p.ID <= 151:
			p.Generation = 1
			p.Region = "Kanto"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Kanto"
		case p.ID <= 251:
			p.Generation = 2
			p.Region = "Johto"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Johto"
		case p.ID <= 386:
			p.Generation = 3
			p.Region = "Hoenn"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Hoenn"
		case p.ID <= 493:
			p.Generation = 4
			p.Region = "Sinnoh"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Sinnoh"
		case p.ID <= 649:
			p.Generation = 5
			p.Region = "Unova"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Unova"
		case p.ID <= 721:
			p.Generation = 6
			p.Region = "Kalos"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Kalos"
		case p.ID <= 809:
			p.Generation = 7
			p.Region = "Alola"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Alola"
		case p.ID <= 905:
			p.Generation = 8
			p.Region = "Galar"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Galar"
		case p.ID <= 1010:
			p.Generation = 9
			p.Region = "Paldea"
			p.RegionLink = "https://bulbapedia.bulbagarden.net/wiki/Paldea"
		}
